...
/**
 * @file stats.c
 * @brief The implementation file of the assignments1
 *
 * This file includes all the required functions implementations in the assignment1
 *
 * @author Yunus Emre Barmanbek
 * @date 3/7/2023
 *
 */
